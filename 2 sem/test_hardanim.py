...
wid = int(input('Введите ширину лабиринта:  '))
...
# def plot_route_back(x,y):                                         # solution list contains all the coordinates to route back to start
#     while (x, y) != (20,20):                                     # loop until cell position == start position
#         x, y = solution[x, y]                                    # "key value" now becomes the new key                                      # animate route back
#         time.sleep(.1)
